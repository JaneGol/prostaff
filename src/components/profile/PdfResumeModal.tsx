...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .skill-tag { background-color: #eceefb; border: 1px solid #c8cde8; border-radius: 6px; padding: 4px 10px; font-size: 10pt; font-weight: 500; color: #2a2a4a; line-height: 1.4; white-space: nowrap; }
