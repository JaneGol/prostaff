                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input className="!text-[24px] !font-semibold h-12" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Иван" />
                      </div>
                      <div className="space-y-2">
                        <Label className="text-[14px]">Фамилия *</Label>
                        <Input className="!text-[24px] !font-semibold h-12" value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Иванов" />
                      </div>
                    </div>
                  </div>
